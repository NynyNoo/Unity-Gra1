...
public class HUD : MonoBehaviour
{
    ...
    private const int SELECTION_NAME_HEIGHT = 60;
    private int cursorScalar = 500;
    ...
    private void DrawResourcesBar()
    {
        ...
        if (GUI.Button(menuButtonPosition, "Faster!"))
        {
    ...
    private void DrawMouseCursor()
    {
        ...
        else
        {
            ...
            //cursorPosition.width *= cursorScalar;
            //cursorPosition.height *= cursorScalar;
